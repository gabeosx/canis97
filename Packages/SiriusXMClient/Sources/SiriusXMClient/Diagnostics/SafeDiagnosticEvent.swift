...
enum SafeDiagnosticOutcome: String, Sendable, Equatable, CaseIterable {
    ...
    case subscriptionsItemsMissing = "subscriptions-items-missing"
    case subscriptionsItemsUnexpectedShape = "subscriptions-items-unexpected-shape"
    case subscriptionItemUnexpectedShape = "subscription-item-unexpected-shape"
