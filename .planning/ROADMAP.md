...
- [x] 04-02-PLAN.md — Import hostile local `.siriusskin` packages through strict archive, path, manifest, image, budget, cancellation, and atomic managed-storage validation.

**Wave 3** *(blocked on Wave 2 completion)*

- [x] 04-03-PLAN.md — Complete accessible appearance management, safe imported-skin removal, and package-independent Player-menu Native recovery.
