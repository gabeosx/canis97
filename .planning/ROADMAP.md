...
- [ ] 01-12-PLAN.md — Make WebView credential selection atomic across suspension and prove exactly one transfer under concurrent explicit selections.
...
| 1. Safe Interoperability Foundation | 11/12 | In Progress|  |
