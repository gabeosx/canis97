...
enum ExpressiveSkinPhaseContract {
    ...
    static func run(arguments: [String]) throws {
        ...
        try require(player.contains("BoundedMarqueeText") && player.contains("TimelineView(.animation") && player.contains("accessibilityReduceMotion") && player.contains(".clipped()"), "bounded expressive text must marquee with a reduced-motion fallback")
