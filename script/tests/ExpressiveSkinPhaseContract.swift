...
enum ExpressiveSkinPhaseContract {
    ...
    static func run(arguments: [String]) throws {
        ...
        try require(player.contains("expressiveSlotAlignment") && player.contains("expressiveSlotOpticalOffset") && player.contains("expressiveTransportControlCenters") && player.contains("menuIndicator(.hidden)") && player.contains("minimumScaleFactor(0.72)") && player.contains("minimumScaleFactor(0.78)"), "expressive slot content must remain inset, aligned, and bounded")
